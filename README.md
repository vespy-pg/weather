...
- Flowing wind streams that progress from nearly straight in calm conditions to curls and loops in stronger wind, with an explicit tornado funnel and optional hourly direction arrows and speed values.
