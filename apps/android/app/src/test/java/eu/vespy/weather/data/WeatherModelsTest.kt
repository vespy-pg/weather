...
class WeatherModelsTest {
    ...
    fun groupingMatchesWebGranularityAndAggregatesValues() {
        val points = listOf(
            point("2026-09-16T00:00", 10.0, 0.2).copy(relativeHumidity = 40.0, surfacePressure = 1000.0, uvIndex = 0.0, pollen = PollenForecast(0.0, 0.0, 2.0, 0.0, 0.0, 0.0), airQuality = AirQualityForecast(20.0, 4.0, 8.0, 10.0, 40.0, 1.0, 180.0)),
            point("2026-09-16T01:00", 12.0, 0.3).copy(relativeHumidity = 60.0, surfacePressure = 1002.0, uvIndex = 2.0, pollen = PollenForecast(0.0, 0.0, 6.0, 0.0, 0.0, 0.0), airQuality = AirQualityForecast(40.0, 8.0, 12.0, 14.0, 60.0, 3.0, 220.0)),
        ...
        assertEquals(30.0, grouped[0].airQuality!!.europeanAqi!!, 0.001)
