...
test('pollen forecast uses the European air-quality endpoint and aggregates a day by peak concentration', () => {
  ...
  assert.deepEqual(hourlyAirQuality({hourly: {
    time: ['2026-09-20T00:00', '2026-09-20T01:00'], european_aqi: [20, 31], pm2_5: [4, 7], pm10: [8, 12], nitrogen_dioxide: [10, 14], ozone: [42, 55], sulphur_dioxide: [1, 2], carbon_monoxide: [180, 220]
  }}, '2026-09-20T01:00'), {europeanAqi: 31, pm25: 7, pm10: 12, nitrogenDioxide: 14, ozone: 55, sulphurDioxide: 2, carbonMonoxide: 220});
...
test('normalizeReverseLocation uses the nearest named locality and country', () => {
  ...
  assert.deepEqual(normalizeReverseLocation({
    ...
    address: {hamlet: 'Jastrząb Rozparcelowany', village: 'Jastrząb', county: 'Myszkowski', state: 'Śląskie', postcode: '42-310', country: 'Poland', country_code: 'pl'}
  }, fallback), {
    ...fallback,
    name: 'Jastrząb Rozparcelowany',
    country: 'Poland',
